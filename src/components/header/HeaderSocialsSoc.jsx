...
const HeaderSocialsSoc = () => {
  return (
      <div className="header__socials-soc">
        ...
        {/* Snapchat */}
        <a href="https://t.snapchat.com/Ute8DVHL" rel="noreferrer" target="_blank">
            <BsSnapchat />
        </a>

        {/* Twitter */}
        <a href="https://twitter.com/travislogant?s=21&t=ybeDcZrJwGYJsB47_1VGJQ" rel="noreferrer" target="_blank">
            <BsTwitter />
        </a>

        {/* Apple Music */}
        <a href="https://music.apple.com/profile/travislogant" rel="noreferrer" target="_blank">
            <SiApplemusic />
          </a>
