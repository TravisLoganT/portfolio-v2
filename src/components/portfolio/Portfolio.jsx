...
const projects = [
  ...
  // project 4
  {
    ...
    image: IMG4,
    description:
      "This was my first attempt at creating my own personal website. I used HTML, CSS and JavaScript to create this website. I focused on a simple, modern design including a responsive layout.",
  ...
  // project 5
  {
    ...
    image: IMG5,
    description:
      "This project was built to help assist estate agents in managing their properties. This was a Java based applicatioon that was used for tracking sales and rentals of properties. Acurate reporting and tracking of properties; that were differientiated by their seller, branch and locations.",
  ...
  // project 6
  {
    ...
    image: IMG6,
    description:
      "This was a assignment where we had to learn how to implement and optimise Google's PageRank Algorithm. Allowing me to learn how to implement and optimise algorithms, operate nodes and edges to improve its implementations, as well as, developing my soft skills in presentation, logical thinking, and mathematical understanding.",
