...
const testimonials = [
	{
		avatar: AVATAR1,
		name: "Kamran Ahmed",
		title: "Software Engineer  |  Topgrad",
		review:
...

	{
		avatar: AVATAR2,
		name: "Thomas Simpson",
		title: "Games Developer  |  EA Games",
		review:
...

	{
		...
		title: "MBCHB Medicine  |  University of Leeds",
		review:
...

	{
		avatar: AVATAR4,
		name: "Nancy Garner",
		title: "Environmental Chemist  |  Newcastle Univeristy",
		review:
	...
	},
	{
		avatar: AVATAR5,
		name: "Ruell Coulson",
		title: "Programming Mentee  |  Leeds City College",
		review:
...

	{
		avatar: AVATAR6,
		name: "Silvia Carbone",
		title: "Senior Lab Quality Engineer  |  Johnson & Johnson MedTech",
		review:
